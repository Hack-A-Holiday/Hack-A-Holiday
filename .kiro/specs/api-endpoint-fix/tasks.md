...
- [ ] 3. Fix flight search API endpoints
  - [ ] 3.1 Update FlightSearch component API calls
...
- [ ] 5. Fix attraction recommendation API endpoints
  ...
  - [ ] 5.3 Update attraction API calls in flight search page
